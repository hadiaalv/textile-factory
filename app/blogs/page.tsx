...
export default function Blogs() {
  return (
    <section className="container py-20">
      ...
      <h1 className="mt-3 text-4xl font-bold">Industry Insights</h1>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <article className="glass p-6 rounded-xl">
          ...
          <p className="mt-3 text-sm text-gray-600">Discover how sensors and data-driven fabric technologies are shaping next-generation products.</p>
        </article>
        <article className="glass p-6 rounded-xl">
          <h2 className="text-2xl font-semibold">Closing the Loop with Circular Textiles</h2>
          <p className="mt-3 text-sm text-gray-600">Our strategies for reducing waste, recycling fibers, and scaling responsible production.</p>
        </article>
      </div>
    </section>
  );
