...
export default function Services() {
  return (
    <section className="container py-20">
      ...
      <h1 className="mt-3 text-4xl font-bold">Services</h1>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <article className="glass p-6 rounded-xl">
          ...
          <p className="mt-3 text-sm text-gray-600">Custom fabric engineering, performance testing, and certification support for demanding applications.</p>
        </article>
        <article className="glass p-6 rounded-xl">
          <h2 className="text-2xl font-semibold">Manufacturing Support</h2>
          <p className="mt-3 text-sm text-gray-600">Integrated production planning, quality assurance, and supply chain coordination for reliable delivery.</p>
        </article>
      </div>
    </section>
  );
